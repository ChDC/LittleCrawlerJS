;(function(deps, factory) {
  ...
  if (typeof define === "function" && define.amd)
    ...
    window["LittleCrawler_test"] = factory(chai, LittleCrawler);
  ...
  ************************************/
  ...
  describe('使用说明示例', () => {
    ...
    before(() => {
      ...
      return LittleCrawler.ajax("get", "LittleCrawler.test.data.html")
        .then(data => html = data)
        .then(() => LittleCrawler.ajax("get", "LittleCrawler.test.data.json"))
        .then(data => json = data);
    });
